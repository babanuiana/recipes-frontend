...
const SIGN_IN_URL = "http://localhost:4000/authentication/sign-in";
const SIGN_UP_URL = "http://localhost:4000/authentication/sign-up";
const CURRENT_USER_URL = "http://localhost:4000/authentication/me";
